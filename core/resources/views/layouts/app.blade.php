...
<div class=" sidebar-wrapper">
    <div class="logo">
                <img src="https://alghaimtours.com/wp-content/uploads/2022/01/Logo-1-jpg.png" style="width:200px"/>
        </a>
    </div>
    <ul class="nav">
...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <span class="icon-bar"></span> 
            ...
            <a class="navbar-brand" href="#"><p>Al Ghaim Tours</p></a>
        </div>
...
<footer class="footer">
    <div class="container-fluid">
        ...
        <div class="copyright pull-right">
            © 2022, made with <i class="fa fa-heart heart"></i> by Amirul Haque</a>
        </div>
    </div>
</footer>
</div>
