...
Route::get('/add_client','ClientController@addclient')->name('addClient');
Route::post('/save_client','ClientController@Saveclient')->name('Saveclient');
Route::get('/edit_client/{id}','ClientController@editclient')->name('editclient');
Route::post('/update_client','ClientController@updateclient')->name('Updateclient');
Route::get('/view_client/{id}','ClientController@viewclient')->name('viewclient');
Route::get('/delete_client/{id}','ClientController@deleteclient')->name('deleteclient');
